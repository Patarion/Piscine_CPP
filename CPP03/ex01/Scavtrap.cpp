...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/02/28 10:29:49 by jgagnon           #+#    #+#             */
/*   Updated: 2023/02/28 10:29:50 by jgagnon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Scavtrap::Scavtrap(std::string name) : Claptrap(name) {
    ...
    _Energy = 50;
    _Attack_Damage = 20;
    std::cout << _Name << " 2.0 est créé! L'update n'enlève pas qu'il est tannant..." << std::endl;
}
...
Scavtrap::~Scavtrap() {
    std::cout << _Name << " a succumbé aux escaliers ou d'une balle perdue. J'vois pas de différence!" << std::endl;
}
