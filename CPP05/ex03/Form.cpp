...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/03/05 15:02:05 by jgagnon           #+#    #+#             */
/*   Updated: 2023/03/05 15:02:07 by jgagnon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "Form.hpp"

Form::Form(std::string name, int grade, int exec) : _name(name), _signe(false), _g_signe(grade), _g_exec(exec){
    try {
